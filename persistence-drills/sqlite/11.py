...
if __name__ == "__main__":
    ...
    print("\n--- Inserting Products ---")
    product_db.insert_new_product("", 10.99) # Invalid
    product_db.insert_new_product("Phone", -500) # Invalid
    product_db.insert_new_product("Phone", 699.99) # Valid
    product_db.insert_new_product("Laptop", 1299.99) # Valid
    product_db.insert_new_product("Tablet", 399.50) # Valid
